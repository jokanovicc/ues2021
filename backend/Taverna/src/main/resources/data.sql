...
INSERT INTO KORISNIK(blokiran,ime,korisnicko,prezime,roles,sifra,adresa) VALUES (0,'Janko','janko','Jankovic','PRODAVAC','$2y$12$Gzr4ylnTWwZ2enY.AbVTbO78wS6bf8OIdC5VA7qTSCcw.vjXvaHwO','Mileticeva 21 Zrenjanin');
...
INSERT INTO PRODAVAC(korisnik_id,naziv, posluje_od,imejl) VALUES (4,'Ресторан Галија','2014-05-10','jankovic@gmail.com');
...
insert into artikal(cena,naziv,opis,prodavac_korisnik_id,obrisan) values (80,'Бурек','Sed vitae vulputate orci. Sed a facilisis sapien. Nulla facilisi. Phasellus ut pellentesque ante. Nulla facilisi. Cras eget lacinia felis, in fermentum nulla.м',4,false);
